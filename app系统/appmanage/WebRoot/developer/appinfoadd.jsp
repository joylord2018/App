...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>新增APP基础信息 <i class="fa fa-user"></i><small>${dev.devname }</small></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_content">
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="backend/addinfo.html" method="post" enctype="multipart/form-data">
          <div class="item form-group">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="file" class="form-control col-md-7 col-xs-12" name="pic"  required="required" id="logopicpath"/>
