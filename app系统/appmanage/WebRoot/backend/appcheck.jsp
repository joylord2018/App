...
<script type="text/javascript">
	$(function(){
		$("[name='status']").click(function(){
			var st=$(this).val();
			var id=$("#id").val();
			$.getJSON("backend/check.html",{"id":id,"st":st},function(res){
					var flag=confirm(res);
					if(flag==true){
						window.location.href="backend/infopage.html";
					};
			});
		});
	});
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="#" method="post">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${in.softwarename }" 
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              value="${in.apkname }" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" 
              	value="${in.supportrom }" type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" readonly="readonly"
              	value="${in.interfacelanguage }" type="text">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${in.softwaresize }"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${in.downloads }"
               class="form-control col-md-7 col-xs-12" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${in.fname }" readonly="readonly">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${in.t1 }-> ${in.t2 } -> ${in.t3 }" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${in.sname }" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea class="form-control col-md-7 col-xs-12" readonly="readonly">${in.appinfo }</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				    ...
				    <img src="${in.logopicpath }" width="100px;"/> 
            </div>
          </div>
        	<div class="form-group">
        		<div class="col-md-6 col-md-offset-3">
        		<button id="tg" type="button" name="status" value="2" class="btn btn-success">审核通过</button>
        		<button id="btg" type="button" name="status" value="3" class="btn btn-success">审核不通过</button>
          		<button type="button" class="btn btn-primary" id="back" onclick="javascript:window.location.href='backend/infopage.html';">返回</button>
        		</div>
     		</div>
        </form>
        </div>
        ...
        <form class="form-horizontal form-label-left">
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${v.versionno }" 
              type="text" readonly="readonly" >
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" value="${v.versionsize }" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="hidden" name="publishStatus" id="publishStatus" value="${v.sname }">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea class="form-control col-md-7 col-xs-12">${v.versioninfo }</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			    <p>${v.apkfilename}&nbsp;&nbsp;
			    <a href="backend/download.html?fpath=${v.downloadlink }" >下载</a>
			    </p>  
            </div>
          </div>
          <div class="clearfix"></div>
